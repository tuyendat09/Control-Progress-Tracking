...
export default function LoginHeader({ iconSize, variant = 'mobile' }: LoginHeaderProps) {
  if (variant === 'brand') {
    return (
      <div>
        ...
        <h1 className="text-[48px] font-semibold leading-[1.05] tracking-[-1px] text-white">
          Control
        </h1>
        <p className="mt-3.5 max-w-[380px] text-[20px] font-normal leading-[1.45] tracking-[-0.4px] text-white/60">
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="text-center text-[34px] font-semibold leading-[1.10] tracking-[-0.374px] text-[#1d1d1f]">
        Control
      </div>
      <div className="mt-2 text-center text-[17px] font-normal leading-[1.47] tracking-[-0.374px] text-[#7a7a7a]">
        Track progress. Own your goals.
      </div>
    </div>
  )
